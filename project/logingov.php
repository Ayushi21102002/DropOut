...
<body style="background-image: url(image.jpg); background-repeat:no-repeat; background-size:cover;"class="img img responsive``">
    <div class="container-fluid bg">
        <div class="row">
            ...
            <form class="form-container" style="border:1px solid black ; padding: 30px 60px; margin-top:20vh ;">
                <center>
                    <img src="bgremoved.png" alt="" srcset="" class="img img-responsive" style="width:25%;">
                    </center><br>
                <div class="form-group">
                    
                    <label for="email" style="font-weight:bolder; font-size: 18px;">ID</label>
                    <input type="text" class="form-control" placeholder="School Index Number"
                        required />
